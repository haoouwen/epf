<html>
  ...
  <body>
   	<@s.form action="/bmall_Sendbox_insert.action" method="post" validate="true" id="sendForm">
   ...
   <div class="rwTitle">
        ...
        <div class="email">
          <table width="100%" cellpadding="0" cellspacing="0" class="writeTab">
          	<tr>
            	<th><span>*</span>发送至：</th>
            	<td><span>${send_cust_name_member?if_exists}</span>
            	</td>
            </tr>
            <tr>
            	<th><span>*</span>主题：</th>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="reset" class="submitbut" value="重置">
                </td>
            </tr>
          </table>
        </div>
