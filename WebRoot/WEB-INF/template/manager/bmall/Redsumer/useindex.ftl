...
<div class="wR810">
	...
	<div class="rwTitle">
		...
		<div class="tabIDiv">
			...
			<input type="button" class="siBut" value="已使用红包" onclick="linkToInfo('/bmall_Redsumer_useList.action','parentMenuId=${parentMenuId?if_exists}&selli=${selli?if_exists}')"/>
	    	...
	    	<table width="100%" cellpadding="0" cellspacing="0" class="usedTab">
	    		...
	    		<tr>
	    		  ...
	    		  <td>${redsumer.money?if_exists}</td>
	    		   <td>${redsumer.order_id?if_exists}</td>
	    		   <td class="mgray"><p>${redsumer.use_date?if_exists[0..10]}</p><p>${redsumer.use_date?if_exists[11..18]}</p></td>
