...
<head>
    ...
    <script src="/include/admin/js/ordercount.js" type="text/javascript"></script>  
...
<body>
	...
	<@s.form action="/bmall_InfoCount_ordernum.action" id="Formtotal" method="post" validate="true" >
...
<div class="rightside f_right">
   <div class="postion">
	统计数据</a><span>></span><a href="#">销售统计</a><span>></span><a href="#">订单数</a>
   </div>
   <div class="ropot">
       <h2 class="rotitle">
       		<span><td class="fthstyle1">订单数</td></span>
       </h2>
