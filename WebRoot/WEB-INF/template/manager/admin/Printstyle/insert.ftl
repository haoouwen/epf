<html>
  ...
  <body>
<@s.form action="/admin_Printstyle_insert.action" method="post" validate="true" id="modiy_form" onSubmit="doSomething()">
<!--当前位置开始-->
<div class="postion">
当前位置:商城管理 > 配送管理 > 运单管理 > 添加运单样式
</div>
<!--当前位置结束-->
<div class="rtdcont">
	<div class="rdtable">
		<table  width="100%" cellspacing="0" cellpadding="0">
		 <!--详细页table的数据开始-->
		   <tr>
             <td class="table_name"  width="20%">模板代码<font color='red'>*</font></td>
             <td>
             	<@s.textfield name="printstyle.template_code" cssClass="txtinput" maxLength="100" csssStyle="width:100px;"/>
             	<@s.fielderror><@s.param>printstyle.template_code</@s.param></@s.fielderror>                   
             </td>
           </tr>
           ...
           <tr>
             ...
             <td>
            	<@s.textfield name="printstyle.template_name" cssClass="txtinput" maxLength="100" csssStyle="width:100px;"/>
             	<@s.fielderror><@s.param>printstyle.template_name</@s.param></@s.fielderror>              
             </td>
           </tr>
           
           <tr>
             <td class="table_name">运单图片:</td>
             <td>
