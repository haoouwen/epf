<html>
  ...
  <@s.form action="/admin_Sendmode_update.action" method="post" validate="true" id="modiy_form">
<div class="postion">
  当前位置:商城管理 > 配送管理 > 快递公司> 修改快递公司
</div>
<div class="rtdcont">
	<div class="rdtable">
   ...
   <div class="bsbut_detail">
    <@s.token/>    
	       <@s.hidden name="oldinfotitle" value="${sendmode.smode_name?if_exists}"/>
