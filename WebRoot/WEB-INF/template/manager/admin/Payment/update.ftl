...
<body>
<@s.form action="/admin_Payment_update.action" method="post" validate="true" id="modiy_form">
<!--当前位置开始-->
<div class="postion">
当前位置:系统管理 > 系统管理 > 支付方式管理 > 修改支付方式
</div>
<!--当前位置结束-->
<div class="rtdcont">
	<div class="rdtable">
        ...
        <tr>
         ...
         <td>
           ...
           <tr>
             <td class="table_name">密钥:</td>
             <td>
             	<@s.textfield name="passwd" type="text" cssClass="txtinput" maxLength="30" value="${(payment.passwd)?if_exists}" cssStyle="width:300px;" />
           ...
           <tr>
             ...
             <td>
             	<@s.textfield name="newAppID" cssClass="txtinput" maxLength="20" value="${(payment.appID)?if_exists}" cssStyle="width:300px;"/>
             	<@s.fielderror><@s.param>newAppID</@s.param></@s.fielderror>
             	<img class='ltip' src="/include/common/images/light.gif" alt="主要用于微信支付">
             </td>
           </tr>
            ...
            <tr>
             ...
             <td>
             	<@s.textfield name="newAppSecret" cssClass="txtinput" maxLength="100"  value="${(payment.appSecret)?if_exists}" cssStyle="width:300px;"/>
             	<@s.fielderror><@s.param>newAppSecret</@s.param></@s.fielderror>
             	<img class='ltip' src="/include/common/images/light.gif" alt="主要用于微信支付">
             </td>
           </tr>
           <tr>
             ...
             <td>
         	 <@s.radio name="payment.enabled" list=r"#{'0':'是','1':'否'}" />
