<html>
  ...
  <body>
  <@s.form action="/admin_Auditmodel_update.action" method="post" validate="true" id="modiy_form">
<div class="postion">
  <!--当前位置-->
  当前位置:系统管理 > 系统设置 > 修改审核模型
</div>
<div class="rtdcont">
	<div class="rdtable">
		 ...
		 <!--详细页table的数据-->
		             ...
		             <td>
		             	...
		             	<@s.fielderror><@s.param>auditmodel.model_type</@s.param></@s.fielderror>
		             	 <@s.hidden  name="oldinfotitle" value="${auditmodel.model_type}"/>
		             </td>
		           </tr>
   ...
   <div class="bsbut_detail">
    <!--操作按钮-->
           ...
           <@s.submit value="保存" />
	       <@s.reset value="重置"/>
	       <@s.hidden name="audti_model_type" /> 
