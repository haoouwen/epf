<html>
  ...
  <body>  
<@s.form action="/admin_Floormark_insert.action" method="post" validate="true"  id="detailForm">
<div class="postion">
	当前位置：网站管理 > 首页楼层 > 添加楼层标签
</div>
<div class="rtdcont">
	<div class="rdtable">
		<table  width="100%" cellspacing="0" cellpadding="0">
	      ...
	      <tr>
	           ...
	           <td class="table_right">
	                <@s.radio name="floormark.fm_type" list=r"#{'0':'商品','1':'图片'}"value="0"/>
	         ...
	         <tr>
	           ...
	           <td class="table_right">
	             	<@s.textfield name="floormark.fm_sort" cssStyle="width:50px;" maxLength="10"  value="0"/>
