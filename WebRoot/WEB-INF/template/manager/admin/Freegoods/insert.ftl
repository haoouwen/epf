<html>
  ...
  <body>  
<@s.form action="/admin_Freegoods_insert.action" method="post" validate="true"  id="detailForm">
<div class="postion">
	当前位置：营销推广 > 赠品 > 添加赠品
</div>
<div class="rtdcont">
	<div class="rdtable">
	    ...
	    <tr>
	           ...
	           <td class="table_right">
	             	<@s.textfield name="freegoods.fg_sort" cssClass="txtinput" maxLength="5" value="0" cssStyle="width:50px;" onkeyup="checkNum(this);"/>
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	           <@s.radio name="freegoods.fg_state" list=r"#{'0':'启用','1':'禁用'}" value="0" onclick="getMemValue();"/>
