<html>
  ...
  <body>  
<@s.form action="/admin_Rechargeablecard_insert.action" method="post" validate="true"  id="detailForm">
<div class="postion">
	当前位置：营销推广 > 促销管理 > 添加充值卡
</div>
<div class="rtdcont">
	<div class="rdtable">
		<table  width="100%" cellspacing="0" cellpadding="0">
			 ...
			 <tr>
			  ...
			  <tr>
			             ...
			             <td>
			             	<input type="text"  name="rechargeablecard.carddate" value="" class="Wdate upWdate" style="width:162px;" id="updown1" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'2020-4-3'})"/>
