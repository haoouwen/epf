...
<body>
<@s.form action="/admin_Directsell_list.action" method="post"  id="indexForm">
<!--当前位置-->
	   ...
	   <div class="rseacher">
	     <table cellpadding="0" cellspacing="0">
	      <tr>
	       ...
	       <td><input type="button" class="rbut" onclick="linkToInfo('/admin_Directsell_add.action','');"  value="添加"></td>
	       <td>&nbsp;&nbsp;预售商品列表说明：<img class="ltip" src="/include/common/images/light.gif" 
	          alt="时间说明：<br/>1，预售开始时间：指商品开始预售的时间<br/> 2，预售结束时间：指预售商品定金付款截止时间<br/>状态说明：<br/>1，预售中：指预售开始时间到尾款开始时间加上系统设置的时间段<br/>2，预售结束：指尾款支付截止时间后"></td>
	   </tr>
	  </table>
	</div>
<!--条件结束-->
...
<!--后台table-->
   <div class="rtable">
     <table width="100%" cellspacing="0" cellpadding="0" class="indexTab">
      <tr >
	         <th width="3%" ><input type="checkbox" name="checkbox" id="checkall" onclick="selectAllBoxs('checkall','directsell.trade_id')"/></th>
	   		
	   	     <th width="5%"  align="center" >排序</th>
	   		
	         <th width="22%"  align="center" >预售标题</th>
		...
		<#list directsellList as directsell>
		  <tr>
		    <td>
		          ...
		          <#else>
		             <input type="checkbox" name="directsell.trade_id" value="${directsell.trade_id?if_exists}" disabled="true"/> 
		          </#if>
		    </td>    
		    	...
		    	<td align="center">
		    	              ...
		    	              预售价格：<font color='red'>${directsell.direct_price?if_exists}</font>
		    	</td>
...
<!--按钮操作存放-->
   <div class="bsbut">
     <input type="button" class="rbut" onclick="updateSort('directsell.trade_id','isort_no','/admin_Directsell_updateSort.action');" value="排序">
     <input type="button" class="rbut" onclick="delInfo('directsell.trade_id','/admin_Directsell_deletetorecycle.action');" value="删除">
   </div>
<!--按钮操作存放结束-->
</div>
<!--表单框隐藏域存放-->
...
<!--搜索区域开始-->
	...
	<@s.form action="/admin_Directsell_list.action" method="post"  id="form_search_id">
...
<script language="javascript" type="text/javascript" src="/include/admin/js/directsell.js"></script>
