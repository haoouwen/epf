		 ...
		 <!--详细页table的数据-->
		            ...
		            <tr>
		             ...
		             <td colspan="3">
		                 ...
		                 <#if hidden_goodsname!=null && hidden_goodssaleprice!=null>
		                      商品名称：</b><span id="goodsname">${hidden_goodsname?if_exists}</span>
		          ...
		          <tr>
		              ...
		              <td colspan="3">
		    				 <#if labList?if_exists?size gt 0 &&labList.lownum!='1'>
																...
																<#list labList as lab>
																		...
																		￥<input type="text" value="${lab.price?if_exists}"name="ladprices" style="width:142px;" maxlength="6" onkeyup="checkRMB(this)"maxlength="6"/>
																	<#assign uptr=uptr+2/>
																</#list>
							</#if>
		           ...
		           <tr>
			             ...
			             <td>
			             	<input type="text"  name="directsell.start_time" value="<#if directsell!=null&&directsell.start_time!=''>${directsell.start_time[0..18]}</#if>" class="Wdate upWdate" style="width:162px;" id="updown1" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'updown2\',{M:0,d:0})||$dp.$DV(\'2020-4-3\',{M:0,d:0})}'})"/>
			             	<@s.fielderror><@s.param>directsell.start_time</@s.param></@s.fielderror>
			             </td>
			              <td class="table_name">预售结束时间<font color='red'>*</font></td>
			             <td>
			             	  <input type="text"  name="directsell.end_time"  value="<#if directsell!=null&&directsell.end_time!=''>${directsell.end_time[0..18]}</#if>"  class="Wdate downWdate" style="width:162px;" id="updown2" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'updown1\',{M:0,d:0});}',maxDate:'2020-4-3'})"/>
			      ...
			      <tr>
		           ...
		           <tr>
		             ...
		             <td colspan="3">
		             	<@s.textfield name="directsell.stock" cssClass="txtinput" onkeyup="checkDigital(this);" onkeyup="checkDigital(this);" maxlength="6"cssStyle="width:60px;"/>
		             	 预设的库存数量为：
		             	 ${(directsell.stock_maxbuy)?if_exists}
		           ...
		           <tr>
										             ...
										             <td colspan="2">
										             	<@s.radio name="directsell.is_limit" list=r"#{'0':'是','1':'否'}"  />
