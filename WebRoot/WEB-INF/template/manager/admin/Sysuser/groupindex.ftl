...
<@s.form action="/admin_Sysuser_groupList.action" method="post" id="indexForm">
...
<div class="rtdcont">
   ...
   <div class="rtable">
     ...
     <#list userList as user>
		 <tr>
	        <td><a href="/admin_Sysuser_list.action?role_id_s=${user.role_id?if_exists}">${user.role_name?if_exists}</a></td>
		    <td align="center">${user.info_num?if_exists}</td>
		    <td align="center">
		    	<a href="/admin_Sysuser_list.action?role_id_s=${user.role_id?if_exists}" title="查看"><img src="/include/common/images/audit.png" /></a>
		    </td>
	     </tr>
    </#list>
     </table>
