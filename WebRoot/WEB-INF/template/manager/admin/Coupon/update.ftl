<html>
  ...
  <body>  
<@s.form action="/admin_Coupon_update.action" method="post" validate="true"  id="detailForm">
<div class="postion">
	当前位置：营销推广>优惠券管理 > 修改优惠券
</div>
<div class="rtdcont">
	<div class="rdtable">
	    <h2>基本信息</h2>
		<table  width="100%" cellspacing="0" cellpadding="0">
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<@s.radio name="coupon.info_state" list=r"#{'1':'启用','0':'禁用'}" />
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<@s.radio name="coupon.is_show" list=r"#{'1':'是','0':'否'}"/>
	        ...
	        <!--
			 <tr>
	           ...
	           <td class="table_right">
	             	<input type="radio" name="coupon.coupon_type" value="0" <#if coupon.coupon_type?if_exists=="0">checked</#if>>A类优惠券 说明：此类优惠券，顾客只需获得一张，即可在规定的时间内重复使用。</br>
	             	<input type="radio" name="coupon.coupon_type" value="1" <#if coupon.coupon_type?if_exists=="1">checked</#if>>B类优惠券 说明：此类优惠券，顾客可一次获得多张，但在规定时间内每张只能使用一次，无法重复使用。 只限会员使用。 
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<@s.textfield name="coupon.coupon_num" cssClass="txtinput" maxLength="20" />
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<@s.textarea name="coupon.content" style="width: 300px; height: 100px;" maxLength="50" onpropertychange="if(value.length>50) value=value.substr(0,49)" />
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<#list commparaList as commpara>
	             	  <input type="checkbox" name="coupon.member_level" value="${commpara.level_code}" <#if coupon.member_level?if_exists?index_of('${commpara.level_code?trim}') gt -1>checked</#if>>${commpara.level_name}
	             	</#list>
   ...
   <div class="bsbut_detail">
           ...
           <@s.hidden  id="type"/>
           <@s.hidden name="coupon.coupon_id"/>
           <@s.hidden name="coupon.coupon_type"/>
