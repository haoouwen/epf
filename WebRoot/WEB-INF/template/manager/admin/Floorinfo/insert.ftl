<html>
  ...
  <body>  
<@s.form action="/admin_Floorinfo_insert.action" method="post" validate="true"  id="modiy_form">
<div class="postion">
	当前位置： 网站管理 > 首页楼层  > 添加楼层
</div>
<div class="rtdcont">
		...
		<table  width="100%" cellspacing="0" cellpadding="0">
			 <tr>
	           ...
	           <td class="table_right">
	             	<@s.textfield name="floorinfo.f_tag" cssClass="txtmininput" maxLength="10" />
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<@s.textfield name="floorinfo.f_sort" cssStyle="width:50px;" value="0"/>
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<@s.radio name="floorinfo.f_state" list=r"#{'0':'显示','1':'隐藏'}" value="0" />
	             	<@s.fielderror><@s.param>floorinfo.f_state</@s.param></@s.fielderror>
	           </td>
	        </tr>	
	    
			 <tr>
	           <td class="table_name">是否为系统内置<img class="ltip" src="/include/common/images/light.gif" alt="[是]选择之后不能删除,[否]选择之后可删除"></td>
	           <td class="table_right">
	             	<@s.radio name="floorinfo.is_sys" list=r"#{'0':'是','1':'否'}" value="1"/>
