<html>
  ...
  <body>
<@s.form action="/admin_Goods_storelist.action" method="post"  id="indexForm">
<!--当前位置-->
	<div class="postion">当前位置：商品管理 > 商品管理 > 仓库中商品列表</div>
<!--当前位置结束-->
<!--条件查询-->
	<div class="rtdcont">
	   <div class="rseacher">
	  ...
	  <#list goodsList as goods>
	    <tr >
	     ...
	     <td><input type="checkbox" name="goods.goods_id" value="${goods.goods_id?if_exists}"/></td>
		    ...
		    <td align="center">
				<a onclick="linkToInfo('/admin_Goods_storeview.action','goods.goods_id=${goods.goods_id?if_exists}');"><img src="/include/common/images/bj.gif" /></a>
		    </td>
	  </tr>
	  </#list>
	</table>
...
<!--按钮操作存放-->
   <div class="bsbut">
     <input type="button" class="rbut" onclick="delInfo('goods.goods_id','/admin_Goods_storedelete.action')" value="删除">
     <input type="button" class="rbut" onclick="updateStateup('1','goods.goods_id','/admin_Goods_storeup.action');" value="上架">
   </div>
<!--按钮操作存放结束-->
</div>
<!--表单框隐藏域存放-->
