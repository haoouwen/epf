...
<body>
<@s.form id="goodspost" action="/admin_Goods_update.action" method="post" validate="true" >
	    ...
	    <div class="oper_top"></div>	
										             ...
										             <div class="imgdiv">
												             	...
												             	<div class="showlistimgdiv">
												             	    ...
												             	    <ul id="show_pic" class="show_pic" >
												             	    	...
												             	    	<li><input type='hidden' name='gimg' value="${img?if_exists}"><img src="${img?if_exists}" width='50px' height='50px' />
 																			 <div  class='imgsshowdiv'><a onclick='setImg("${img?if_exists}");'><img class='imgstyle' src='/include/admin/images/setimg.gif'/></a>
																			<a onclick='delImg(this);'><img  class='imgstyle' src='/include/admin/images/delimg.gif'/></a></div>
																		</li>
										  	...
										  	<tr>
									             ...
									             <td  class="table_name_left">	
									             		...
									             		<#elseif ea.option_type?if_exists=='1'>
									             			...
									             			<@s.textarea cssClass="ex_class" name="selfextendattr.ex_attr_value"   onkeyup="checkLength(this,300);"  cssStyle="width:350px;height:70px;"   value="${ea.ex_attr_value?if_exists}"/>
	     ...
	     <div class="fixbuttom">
	      ...
	      <#-- <@s.hidden  id="goods_detail"  name="goods_detail"/>    -->
	       ...
	       <@s.reset value="重置"/>
    		   <input type="button" name="returnList" value="返回列表"  onclick="document.getElementById('goodspost').action='/admin_Goods_list.action';document.getElementById('goodspost').submit();"/>
	     </div>
	</div>
	<div class="clear"/>
</div>
