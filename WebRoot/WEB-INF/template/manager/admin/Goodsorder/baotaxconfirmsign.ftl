<html>
 ...
 <body>
<@s.form action="/admin_Goodsorder_taxconfirsign.action" method="post"  id="indexForm">
<!--当前位置-->
	<div class="postion">当前位置：商城管理 > 保税区发货 > 已签收待评价</div>
<!--当前位置结束-->
<!--条件查询-->
	<div class="rtdcont">
	   <div class="rseacher">
                                  ...
                                  <div class="tddivCont">
                                     ...
                                     <table width="100%" cellspacing="0" cellpadding="0" class="orderTab1">
                                       <tr>
									    ...
									    <a onclick="linkToInfo('/admin_Goodsorder_view.action','goodsorder.order_id=${goodsorder.order_id?if_exists}&order_state=${(goodsorder.order_state)?if_exists}&detail_return_flage=15');" >订单详情</a>
										</td>
                                         <td width="9%"  rowspan="10" class="wltd" >	
...
<!--搜索区域开始-->
	...
	<@s.form action="/admin_Goodsorder_taxconfirsign.action" method="post"  id="form_search_id">
