<html>
 ...
 <body>
<@s.form action="/admin_Goodsorder_confirsign.action" method="post"  id="indexForm">
<!--当前位置-->
	<div class="postion">当前位置：商城管理 > 直邮发货 > 已签收待评价</div>
<!--当前位置结束-->
<!--条件查询-->
	<div class="rtdcont">
	   <div class="rseacher">
                        ...
                        <table width="100%" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td colspan="9">
                                  <div class="tddiv">
                                      <p class="pftd90">
                                        <span>订单编号：<b><a onclick="linkToInfo('/admin_Goodsorder_view.action','goodsorder.order_id=${goodsorder.order_id?if_exists}&order_state=${(goodsorder.order_state)?if_exists}&detail_return_flage=9');" >${(goodsorder.order_id)?if_exists}</a></b></span>
										   <span>状态：
							                     <font color="#005ea7">已签收待评价</font>
										</span>
                                        ...
                                        <span style="color:red">[快递已签收]</span>
                                       </p>
                                        <div class="clear"></div>
                                  </div>
                                  <div class="tddivCont">
                                     ...
                                     <table width="100%" cellspacing="0" cellpadding="0" class="orderTab1">
                                       <tr>
									    ...
									    <a onclick="linkToInfo('/admin_Goodsorder_view.action','goodsorder.order_id=${goodsorder.order_id?if_exists}&order_state=${(goodsorder.order_state)?if_exists}&detail_return_flage=9');" >订单详情</a>
										</td>
...
<!--搜索区域开始-->
	...
	<@s.form action="/admin_Goodsorder_confirsign.action" method="post"  id="form_search_id">
