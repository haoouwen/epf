<html>
 ...
 <body>
<@s.form action="/admin_Goodsorder_clearanceBslist.action" method="post"  id="indexForm">
<!--当前位置-->
	<div class="postion">当前位置：商城管理 > 保税发货 > 待提交海关</div>
<!--当前位置结束-->
<!--条件查询-->
	<div class="rtdcont">
	   <div class="rseacher">
                                      ...
                                      <p class="pftd90">
                                        <span>订单编号：<b><a onclick="linkToInfo('/admin_Goodsorder_view.action','goodsorder.order_id=${goodsorder.order_id?if_exists}&order_state=${(goodsorder.order_state)?if_exists}&detail_return_flage=7');" >${(goodsorder.order_id)?if_exists}</a></b></span>
                                         ...
                                         <#if goodsorder.buy_address?if_exists? length lt 15>
                                          ...
                                          <p class="prtd">
                                       <input type="button" class="cssbtn" onclick="submitkjt('${goodsorder.order_id?if_exists}','1')" value="提交海关">
                                       </p>
