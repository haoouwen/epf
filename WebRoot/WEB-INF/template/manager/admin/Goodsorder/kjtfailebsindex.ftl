<html>
 ...
 <body>
<@s.form action="/admin_Goodsorder_kjtFaileBslist.action" method="post"  id="indexForm">
<!--当前位置-->
	<div class="postion">当前位置：商城管理 > 保税发货 > 海关订单失败</div>
<!--当前位置结束-->
<!--条件查询-->
	<div class="rtdcont">
	   <div class="rseacher">
                                  ...
                                  <div class="tddiv">
                                      <p class="pftd90">
                                        <span>订单编号：<b><a onclick="linkToInfo('/admin_Goodsorder_view.action','goodsorder.order_id=${goodsorder.order_id?if_exists}&order_state=${(goodsorder.order_state)?if_exists}&detail_return_flage=7');" >${(goodsorder.order_id)?if_exists}</a></b></span>
										   <span>海关订单状态</font>：
										   <font color='red'><#list kjtcommparaList as clist>
                                  ...
                                  <div class="tddivCont">
                                     ...
                                     <table width="100%" cellspacing="0" cellpadding="0" class="orderTab1">
                                       <tr>
									    ...
									    <a onclick="linkToInfo('/admin_Goodsorder_view.action','goodsorder.order_id=${goodsorder.order_id?if_exists}&order_state=${(goodsorder.order_state)?if_exists}&detail_return_flage=17');" >订单详情</a>
										</td>
