<html>
  ...
  <body>
<@s.form action="/admin_Goodsorder_auditBsOrderIndex.action" method="post"  id="indexForm">
<!--当前位置-->
	<div class="postion">当前位置：商城管理 > 保税发货 > 待审核发货</div>
<!--当前位置结束-->
<!--条件查询-->
	<div class="rtdcont">
	   <div class="rseacher">
	     <table cellpadding="0" cellspacing="0">
	      <tr>
	       ...
	       <td>  <input type="button" class="rbut" onclick="batchauditOrder();"  value="订单审核"></td>
	        <td><input type="button" onclick="recycle('goodsorder.order_id','/admin_Goodsorder_auditRecycle.action');" class="rbut" value="订单回收"></td>
                                  ...
                                  <div class="tddiv">
                                      <p class="pftd90">
                                         <span><input type="checkbox" name="goodsorder.order_id" value="${goodsorder.order_id?if_exists}"/></span>
                                          <span>订单编号：<b><a onclick="linkToInfo('/admin_Goodsorder_view.action','goodsorder.order_id=${goodsorder.order_id?if_exists}&order_state=${(goodsorder.order_state)?if_exists}&detail_return_flage=4');" >${(goodsorder.order_id)?if_exists}</a></b></span>
                                     ...
                                     <table width="100%" cellspacing="0" cellpadding="0" class="orderTab1">
                                       <tr>
										...
										<td  width="8%"  class="gray" rowspan="9">
                                         ...
                                         <td  width="10%"  class="gray" rowspan="9">
                                          <#if goodsorder.order_para!=''>
									   		${(goodsorder.order_para)?if_exists}
									     </#if><br/>
									    <a onclick="linkToInfo('/admin_Goodsorder_view.action','goodsorder.order_id=${goodsorder.order_id?if_exists}&order_state=${(goodsorder.order_state)?if_exists}&detail_return_flage=12');" >订单详情</a>
										</td>
                                     </table>
                                  </div>
                              </td>
...
<!--搜索区域开始-->
	...
	<@s.form action="/admin_Goodsorder_auditBsOrderIndex.action" method="post"  id="form_search_id">
