<html>
  ...
  <body>
<@s.form action="/admin_Goodsorder_operatorslist.action" method="post"  id="indexForm">
<!--当前位置-->
	<div class="postion">当前位置：商城管理 > 订单管理 > 直邮订单</div>
<!--当前位置结束-->
<!--条件查询-->
	<div class="rtdcont">
	   <div class="rseacher">
...
<!--后台table-->
       ...
       <div class="orderDiv" id="orderDivId">
                ...
                <div class="orderH2">
                  <ul>
                    <li <#if order_state_s=='999'||order_state_s==''>class="selli"</#if>><a href="/admin_Goodsorder_operatorslist.action?order_state_s=999">全部订单</a></li>
                     <#list commparaList as clist>
                    <li <#if order_state_s=='${clist.para_value?if_exists}'>class="selli"</#if>><a href="/admin_Goodsorder_operatorslist.action?order_state_s=${clist.para_value?if_exists}">${clist.para_key?if_exists}</a></li>
                    </#list>
