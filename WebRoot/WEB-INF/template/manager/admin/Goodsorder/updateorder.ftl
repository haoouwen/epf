...
<link href="/include/common/css/alert.css" rel="stylesheet" type="text/css" /> 
  ...
  <body>
  <@s.form action="/admin_Goodsorder_update.action" method="post" validate="true" id="tradeForm">
<div class="postion">	当前位置:商城管理 > 订单管理  > 订单详情</div>
<!--startprint-->
<div class="rtdcont">
	<div class="rttable">
	   <!--列表页table的数据-->	 
					           ...
					           <tr>
						             ...
						             <td>
						                <#if (goodsorder.goods_amount)?if_exists>
										     ${(goodsorder.goods_amount)?string("0.00")}
										 <#else>
										     0.00
										 </#if>
						             ...
						             <td>
						              ...
						              <#list paymentList as plist>
					                     <#if goodsorder.pay_id==plist.pay_id>
					                          ...
					                          <#if goodsorder.pay_code=='wxpay'>
					                             (<#if goodsorder.final_pay_method=='0'>
					                                 PC端微信支付
					                              <#elseif goodsorder.final_pay_method=='1'>
					                                      手机端微信支付
					                             </#if>)
					                          </#if>
					                     </#if>
			 ...
			 <div class="fixbuttom" style="margin-top:10px;">
			  ...
			  <@s.hidden name="goods_order_state" id="goods_order_state"/>
			    <#if goodsorder.sell_cust_id=='0'>
			         ...
			         <input type="button"  onclick="linkToInfo('/admin_Goodsorder_operatorslist.action','order_state=${(order_state)?if_exists}');" value="返回列表">
			         ...
			         <input type="button"  onclick="linkToInfo('/admin_Goodsorder_clearanceSuccesslist.action','order_state=${(order_state)?if_exists}');" value="返回列表">
			         ...
			         <input type="button"  onclick="linkToInfo('/admin_Goodsorder_printsendorder.action','order_state=${(order_state)?if_exists}');" value="返回列表">
			         ...
			         <input type="button"  onclick="linkToInfo('/admin_Goodsorder_confirmdeliver.action','order_state=${(order_state)?if_exists}');" value="返回列表">
			         <#elseif detail_return_flage=="8">
			         <input type="button"  onclick="linkToInfo('/admin_Goodsorder_clearanceSuccesslist.action','order_state=${(order_state)?if_exists}');" value="返回列表">
			         <#elseif detail_return_flage=="9">
			         <input type="button"  onclick="linkToInfo('/admin_Goodsorder_confirsign.action','order_state=${(order_state)?if_exists}');" value="返回列表">
			         <#elseif detail_return_flage=="10">
			         <input type="button"  onclick="linkToInfo('/admin_Goodsorder_clearanceFailelist.action','order_state=${(order_state)?if_exists}');" value="返回列表">
			         <#elseif detail_return_flage=="11">
			         <input type="button"  onclick="linkToInfo('/admin_Goodsorder_clearancelist.action','order_state=${(order_state)?if_exists}');" value="返回列表">
			         <#elseif detail_return_flage=="12">
			         <input type="button"  onclick="linkToInfo('/admin_Goodsorder_auditBsOrderIndex.action','order_state=${(order_state)?if_exists}');" value="返回列表">
			         <#elseif detail_return_flage=="13">
			         <input type="button"  onclick="linkToInfo('/admin_Goodsorder_clearanceSuccessBslist.action','order_state=${(order_state)?if_exists}');" value="返回列表">
			         <#elseif detail_return_flage=="14">
			         <input type="button"  onclick="linkToInfo('/admin_Goodsorder_taxconfirmdeliver.action','order_state=${(order_state)?if_exists}');" value="返回列表">
			         <#elseif detail_return_flage=="15">
			         <input type="button"  onclick="linkToInfo('/admin_Goodsorder_taxconfirsign.action','order_state=${(order_state)?if_exists}');" value="返回列表">
			         <#elseif detail_return_flage=="16">
			         <input type="button"  onclick="linkToInfo('/admin_Goodsorder_clearanceBslist.action','order_state=${(order_state)?if_exists}');" value="返回列表">
			          <#elseif detail_return_flage=="17">
			         <input type="button"  onclick="linkToInfo('/admin_Goodsorder_kjtFaileBslist.action','order_state=${(order_state)?if_exists}');" value="返回列表">
			         </#if>
			         <#else>
			         <input type="button"  onclick="linkToInfo('/admin_Goodsorder_operatorslist.action','order_state=${(order_state)?if_exists}');" value="返回列表">
			       </#if>
