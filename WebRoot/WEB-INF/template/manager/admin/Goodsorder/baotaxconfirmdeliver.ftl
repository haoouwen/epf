<html>
 ...
 <body>
<@s.form action="/admin_Goodsorder_taxconfirmdeliver.action" method="post"  id="indexForm">
<!--当前位置-->
	<div class="postion">当前位置：商城管理 > 保税发货 > 已发货</div>
<!--当前位置结束-->
<!--条件查询-->
	<div class="rtdcont">
	   <div class="rseacher">
...
<!--后台table-->
 ...
 <input type="button"  onclick="modifyfahuoShowDIV('invoice','${goodsorder.order_id?if_exists}','${(goodsorder.tatal_amount)?if_exists}','${(goodsorder.order_time)?if_exists}','${(goodsorder.consignee)?if_exists}','${(goodsorder.area_attr)?if_exists}  ${(goodsorder.buy_address)?if_exists}','${(goodsorder.mobile)?if_exists}','${(goodsorder.send_num)?if_exists}','${(goodsorder.order_weight)?if_exists}','${(goodsorder.send_mode)?if_exists}');"
                                           title="点击修改物流信息" value="修改物流" class="cssbtn"/>
                                       </p>
                                        <div class="clear"></div>
                                  </div>
                                  <div class="tddivCont">
                                     ...
                                     <table width="100%" cellspacing="0" cellpadding="0" class="orderTab1">
                                       ...
                                       <#if (goodsorder.is_sea)?if_exists=='1'>
									    ...
									    <a onclick="linkToInfo('/admin_Goodsorder_view.action','goodsorder.order_id=${goodsorder.order_id?if_exists}&order_state=${(goodsorder.order_state)?if_exists}&detail_return_flage=14');" >订单详情</a>
										</td>
										        	...
										        	<p>
													   ...
													   <div class="wlDiv">     
									                         <div>
									                           <p class="wlp"></p>
									                           <p class="wlpbut"></p>
									                             <table width="100%" cellpadding="1" cellspacing="1" class="logisticsTabTitle">
										                             <tr><td>加载中...</td></tr>
										                          </table>
										                          <table width="100%" cellpadding="0" cellspacing="0" class="logisticsTab">
										                             <tr><td>加载中...</td></tr>
										                          </table>
									                           <input class="order_class" value="${goodsorder.order_id?if_exists}" type="hidden" />
									                           <input class="send_number_class" value="${goodsorder.send_num?if_exists}" type="hidden" />
									                           <input class="send_namer_class" value="${goodsorder.smode_name?if_exists}" type="hidden" />
									                         </div> 
									                    </div>
	                                             </p>
										     </#if>
...
<!--搜索区域开始-->
	...
	<@s.form action="/admin_Goodsorder_taxconfirmdeliver.action" method="post"  id="form_search_id">
