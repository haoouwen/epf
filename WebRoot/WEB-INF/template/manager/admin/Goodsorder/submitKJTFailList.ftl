<html>
 ...
 <body>
<@s.form action="/admin_Goodsorder_submitKJTFailList.action" method="post"  id="indexForm">
<!--当前位置-->
	<div class="postion">当前位置：商城管理 > 直邮发货 > 提交海关失败</div>
<!--当前位置结束-->
<!--条件查询-->
	<div class="rtdcont">
	   <div class="rseacher">
	     <table cellpadding="0" cellspacing="0">
	      <tr>
	       ...
	       <td><input type="submit" class="button button-primary button-rounded button-tiny" value="查询">&nbsp;&nbsp;</td>
	       <td><input type="button" onclick="recycle('goodsorder.order_id','/admin_Goodsorder_sKJTFailSendRecycle.action');" class="button button-primary button-rounded button-tiny" value="订单回收"></td>
	   </tr>
	  </table>
	</div>
<!--条件结束-->
                                  ...
                                  <div class="tddiv">
                                      <p class="pftd90">
                                        ...
                                        <span>订单编号：<b><a onclick="linkToInfo('/admin_Goodsorder_view.action','goodsorder.order_id=${goodsorder.order_id?if_exists}&order_state=${(goodsorder.order_state)?if_exists}&detail_return_flage=7');" >${(goodsorder.order_id)?if_exists}</a></b></span>
                                         ...
                                         <p class="prtd">
                                         <span>  <input type="button"   class="button button-primary button-tiny" 
                                           ...
                                           title="点击取消订单" value="取消订单" class="cssbtn"/></span>
                                       </p>
                                        <p class="prtd">
                                         <span><input type="button"  class="button button-primary button-tiny"    onclick="SubmitToCustomsShowDIV('customs','${goodsorder.order_id?if_exists}')" value="重新提交"></span>
                                       </p>
                                        <div class="clear"></div>
                                  </div>
                                  <div class="tddivCont">
	   ...
	   <table border="0" style="margin-left:30px;margin-right:30px;">
		  <tr>
			...
			<td width="70%" id="orderinfo_id" style="border: 1px solid #EBEBEB">
				<@s.select list="commparaList" listKey="para_value" listValue="para_key" name="para_code" style="width:150px;" id="customs_id"/>
			</td>
		  </tr>
		  <tr>
		  ...
		  <tr>
		   <td colspan="2" align="center" style="border-bottom: 0px">
			 <button type="button" class="button button-royal button-pill button-raised button-small" id="button_submit_customs" onclick="submitCustoms('2')">提交海关</button>
