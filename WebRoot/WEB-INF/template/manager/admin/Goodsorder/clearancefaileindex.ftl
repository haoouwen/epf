...
<!--当前位置-->
	<div class="postion">当前位置：商城管理 > 直邮发货 > 通关失败</div>
<!--当前位置结束-->
<!--条件查询-->
	<div class="rtdcont">
	   <div class="rseacher">
                        ...
                        <table width="100%" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td colspan="9">
                                  <div class="tddiv">
                                      <p class="pftd90">
                                        <span>订单编号：<b><a onclick="linkToInfo('/admin_Goodsorder_view.action','goodsorder.order_id=${goodsorder.order_id?if_exists}&order_state=${(goodsorder.order_state)?if_exists}&detail_return_flage=10');" >${(goodsorder.order_id)?if_exists}</a></b></span>
										   <span>状态：
							                  <#list deliverList as cp>
							                    <#if goodsorder.deliver_state==cp.para_value>
							                     <font color="#005ea7"> ${cp.para_key}/<#if goodsorder.is_clearance?if_exists=='0'> 
							                     <font color="blue">待通关</font><#elseif goodsorder.is_clearance?if_exists=='1'>
							                     <font color="green">通关成功</font><#else><font color="red">通关失败</font></#if></font>
							                    </#if>
							                  </#list>	
										</span>
                                  ...
                                  <div class="tddivCont">
                                     <table width="100%" cellspacing="0" cellpadding="0" class="orderTab1">
                                       <tr>
									    ...
									    <a onclick="linkToInfo('/admin_Goodsorder_view.action','goodsorder.order_id=${goodsorder.order_id?if_exists}&order_state=${(goodsorder.order_state)?if_exists}&detail_return_flage=10');" >订单详情</a>
										</td>
