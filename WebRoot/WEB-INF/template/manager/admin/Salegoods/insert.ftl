<html>
  ...
  <body>  
<@s.form action="/admin_Salegoods_insert.action" method="post" validate="true"  id="detailForm">
<div class="postion">
	当前位置：营销推广 > 促销管理 > 添加商品促销
</div>
<div class="rtdcont">
	<div class="rdtable">
	    <h2>基本信息</h2>
		<table  width="100%" cellspacing="0" cellpadding="0">
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	                <@s.radio name="salegoods.info_state" list=r"#{'1':'启用','0':'禁用'}" value="0"/>
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	                <@s.radio name="salegoods.limit_time" list=r"#{'1':'是','0':'否'}" value="0"/>
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<@s.textfield name="salegoods.priority" cssClass="txtinput" cssStyle="width:40px;" maxLength="20"  value="50" onkeyup="checkNum(this)"/>
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<input type="checkbox" name="salegoods.platform" value="0"<#if salegoods != null && salegoods.platform?if_exists?trim?index_of('0') gt -1>checked</#if>/>PC端
	             	<input type="checkbox" name="salegoods.platform" value="1"<#if salegoods != null && salegoods.platform?if_exists?trim?index_of('1') gt -1>checked</#if>/>触屏端
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	                <@s.radio name="salegoods.is_recome" list=r"#{'1':'是','0':'否'}" value="0"/></br>
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<#list commparaList as commpara>
	             	  <input type="checkbox" name="salegoods.member_level" value="${commpara.level_code}"<#if salegoods != null && salegoods.member_level?if_exists?index_of('${commpara.level_code?trim}') gt -1>checked</#if>/>${commpara.level_name}
	             	</#list>
		...
		<table  width="100%" cellspacing="0" cellpadding="0">
			 <tr>
	           <td class="table_right">
	             	  <input type="radio" name="salegoods.term_state" value="1" onclick="selectRadio('salegoods.term_state','term');clearCoupon();" <#if salegoods != null && salegoods.term_state?if_exists=='1'>checked</#if>>指定商品</br>
	             	  ...
	             	  <input type="radio" name="salegoods.term_state" value="2" onclick="selectRadio('salegoods.term_state','term');clearCoupon();" <#if salegoods != null && salegoods.term_state?if_exists=='2'>checked</#if>>商品分类</br>
	             	  <div class="coupon" id="term2">商品分类<div id="catDiv" style="margin-left:0px;"></div></div>
	             	  <input type="radio" name="salegoods.term_state" value="3" onclick="selectRadio('salegoods.term_state','term');clearCoupon();" <#if salegoods != null && salegoods.term_state?if_exists=='3'>checked</#if>>所有商品</br>
		...
		<table  width="100%" cellspacing="0" cellpadding="0">
			 <tr>
	           <td class="table_right">
	             	  <input type="radio" name="salegoods.coupon_state" value="1" onclick="selectRadio('salegoods.coupon_state','coupon')" <#if salegoods != null && salegoods.coupon_state?if_exists=='1'>checked</#if>>符合应用条件的商品送优惠券</br>
	             	  ...
	             	  <input type="radio" name="salegoods.coupon_state" value="2" onclick="selectRadio('salegoods.coupon_state','coupon')" <#if salegoods != null && salegoods.coupon_state?if_exists=='2'>checked</#if>>符合应用条件的商品送红包</br>
	             	  ...
	             	  <input type="radio" name="salegoods.coupon_state" value="3" onclick="selectRadio('salegoods.coupon_state','coupon')" <#if salegoods != null && salegoods.coupon_state?if_exists=='3'>checked</#if>>符合应用条件的商品以固定折扣出售</br>
	             	   <div class="coupon" id="coupon3">商品价格乘以<input  type="text" style="heigth:24px;" id="coupon_money1" onkeyup="checkNum(this)" <#if salegoods != null && salegoods.coupon_state?if_exists=='3'>value="${salegoods.coupon_plan}"</#if>/>%折扣出售</div>
	             	  <!--
	             	  <input type="radio" name="salegoods.coupon_state" value="4" onclick="selectRadio('salegoods.coupon_state','coupon')" <#if salegoods != null && salegoods.coupon_state?if_exists=='4'>checked</#if>>符合应用条件的商品固定价格购买</br>
	             	  <div class="coupon" id="coupon4">商品价格以<input  type="text" style="heigth:24px;" id="coupon_money2" onkeyup="checkNum(this)" <#if salegoods != null && salegoods.coupon_state?if_exists=='4'>value="${salegoods.coupon_plan}"</#if>/>出售</div>
	             	  <input type="radio" name="salegoods.coupon_state" value="5" onclick="selectRadio('salegoods.coupon_state','coupon')" <#if salegoods != null && salegoods.coupon_state?if_exists=='5'>checked</#if>>符合应用条件的商品减去固定折扣出售</br>
	             	  <div class="coupon" id="coupon5">商品价格减去<input  type="text" style="heigth:24px;" id="coupon_money3" onkeyup="checkNum(this)" <#if salegoods != null && salegoods.coupon_state?if_exists=='5'>value="${salegoods.coupon_plan}"</#if>/>%折扣出售</div>
	             	   -->
	             	  <input type="radio" name="salegoods.coupon_state" value="6" onclick="selectRadio('salegoods.coupon_state','coupon')" <#if salegoods != null && salegoods.coupon_state?if_exists=='6'>checked</#if>>符合应用条件的商品减固定价格购买</br>
	             	  <div class="coupon" id="coupon6">商品价格优惠<input  type="text" style="heigth:24px;" id="coupon_money4" onkeyup="checkNum(this)" <#if salegoods != null && salegoods.coupon_state?if_exists=='6'>value="${salegoods.coupon_plan}"</#if>/>出售</div>
