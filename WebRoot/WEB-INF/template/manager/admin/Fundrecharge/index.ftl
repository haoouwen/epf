<html>
  <head>
    <title>会员余额充值记录表</title>
    <script language="javascript" type="text/javascript" src="/include/components/calendar/WdatePicker.js"></script>
    <script type="text/javascript" src="/include/admin/js/fundcharge.js"></script>
  </head>
  <body>
<@s.form action="/admin_Fundrecharge_list.action" method="post"  id="indexForm">
<!--当前位置-->
	<div class="postion">当前位置：财务统计 >财务管理 > 会员余额充值记录表</div>
<!--当前位置结束-->
<!--条件查询-->
	<div class="rtdcont">
	   <div class="rseacher">
	     <table cellpadding="0" cellspacing="0">
	      <tr>
	       ...
	       <td><input type="button" onclick="export_fundcharge();" class="rbut" value="导出记录"></td>
	   </tr>
	  </table>
	</div>
<!--条件结束-->
     ...
     <table width="100%" cellspacing="0" cellpadding="0" class="indexTab">
	  ...
	  <#list fundrechargeList as fundrecharge>
	    <tr >
		    ...
		    <td align="center">
		      <#if (fundrecharge.bank_order_id)?if_exists!="" || (fundrecharge.bank_order_id)?if_exists!=null>
		     ...
		     <td align="center">
				<#if fundrecharge.order_state?if_exists=='0'><a onclick="linkToInfo('/admin_Fundrecharge_list.action','order_state_s=${fundrecharge.order_state?if_exists}');"><font color='red'>未审核</font></a></#if><#if fundrecharge.order_state?if_exists=='1'><a onclick="linkToInfo('/admin_Fundrecharge_list.action','order_state_s=${fundrecharge.order_state?if_exists}');"><font color='green'>审核通过</font></a></#if><#if fundrecharge.order_state?if_exists=='2'><a onclick="linkToInfo('/admin_Fundrecharge_list.action','order_state_s=${fundrecharge.order_state?if_exists}');"><font color='blue'>作废</font></a></#if>
		    </td>
		     <td align="center">
		    ...
		    <td align="center">
				<a onclick="linkToInfo('/admin_Fundrecharge_view.action','fundrecharge.trade_id=${fundrecharge.trade_id?if_exists}');"><img src="/include/common/images/bj.gif" /></a>
		    </td>
	  </tr>
	  </#list>
	</table>
...
<!--搜索区域开始-->
	...
	<@s.form action="/admin_Fundrecharge_list.action" method="post"  id="form_search_id">
		...
		<tr>
			...
			<td><@s.select name="order_state_s" list=r"#{'1':'审核通过','2':'作废'}" headerKey="" headerValue="请选择"/>  </td>
		</tr>
		<tr>
