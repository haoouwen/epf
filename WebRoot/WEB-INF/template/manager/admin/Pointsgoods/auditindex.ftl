...
<body>
<@s.form action="/admin_Pointsgoods_auditList.action" method="post"  id="indexForm">
<!--当前位置-->
	<div class="postion">当前位置:营销推广 > 积分商品 > 积分商品审核</div>
<!--当前位置结束-->
<div class="rtdcont">
<!--条件查询-->
   <div class="rseacher">
   ...
   <div class="rtable">
     <table width="100%" cellspacing="0" cellpadding="0" class="indexTab">
	  ...
	  <tr>
	    ...
	    <td align="center"><a onclick="linkToInfo('/admin_Pointsgoods_audit.action','pointsgoods.trade_id=${pointsgoods.trade_id?if_exists}');"><img src="/include/common/images/bj.gif" /></a></td>
	  </tr>
	  </#list>
	</table>
  </div>
...
<!--按钮操作存放-->
   <div class="bsbut">
     <input type="button" class="rbut" onclick="updateSort('pointsgoods.trade_id','isort_no','/admin_Pointsgoods_auditUpdateSort.action');" value="排序">
     <input type="button" class="rbut" onclick="delInfo('pointsgoods.trade_id','/admin_Pointsgoods_auditDelete.action')" value="删除">
   </div>
<!--按钮操作存放结束-->
</div>
<!--表单框隐藏域存放-->
