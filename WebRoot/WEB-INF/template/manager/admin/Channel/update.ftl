<html>
  ...
  <body>
  <@s.form action="/admin_Channel_update.action" method="post" validate="true" id="modiy_form">
<div class="postion">
  <!--当前位置-->
  当前位置:网站管理 > 基本功能 > 网站栏目管理 > 修改网站栏目
</div>
<div class="rtdcont">
	<div class="rdtable">
		<table  width="100%" cellspacing="0" cellpadding="0">
		 <!--详细页table的数据-->
             ...
             <td>
             	<@s.textfield name="channel.ch_name" id="cnames"  onblur="updatecheckcname();" cssClass="txtinput" maxLength="20" cssStyle="width:300px;"/>
           ...
           <tr>
             ...
             <td>
             	<@s.textfield name="channel.sort_no" cssClass="txtinput" cssStyle="width:50px;" maxLength="4"/>
            ...
            <tr>
             ...
             <td>
             	<@s.textfield name="channel.save_dir" cssClass="txtinput" cssStyle="width:300px;" maxLength="100"/>
           ...
           <tr>
             ...
             <td>
             	<@s.textfield name="channel.file_name" cssClass="txtinput" maxLength="50" cssStyle="width:250px;"/>
           ...
           <tr>
             ...
             <td>
             	<@s.textfield name="channel.temp_path" id="tempvalue" cssClass="txtinput" cssStyle="width:300px;"  maxLength="100"/>
            ...
            <tr>
             ...
             <td>
             	<@s.textfield name="channel.article_temp" id="tempvalueart" cssClass="txtinput" cssStyle="width:300px;"  maxLength="100"/>
           ...
           <tr>
             ...
             <td>
               <@s.radio name="channel.is_webapp" list=r"#{'0':'PC端','1':'触屏版'}"/>
           ...
           <tr>
             ...
             <td>
             	<@s.textfield name="channel.article_rule" cssClass="txtinput" maxLength="50" cssStyle="width:280px;" />
           ...
           <tr>
             ...
             <td>
             	<@s.textarea name="channel.meta_keyword" cssClass="txtinput" onkeyup="checkLength(this,200);" cssStyle="width:300px;"/>
           ...
           <tr>
             ...
             <td>
             	<@s.textarea name="channel.meta_desc" cssClass="txtinput" onkeyup="checkLength(this,200);" cssStyle="width:300px;"/>
           ...
           <tr>
             ...
             <td>
             	<@s.textarea name="channel.remark" cssClass="txtinput"  onkeyup="checkLength(this,100);" cssStyle="width:300px;"/>
   ...
   <div class="bsbut_detail">
    <!--操作按钮-->
	       <@s.token/>
	       <@s.submit value="保存"/>
	       <@s.hidden name="channel.up_ch_id" value="${(channel.up_ch_id)?if_exists!'0'}" />
	       <@s.hidden name="channel.ch_id" id="hid" value="${channel.ch_id?if_exists}" />
	       <@s.hidden name="channel.ch_level" value="${channel.ch_level!1}" />
	       <@s.hidden name="mall_type" value="${mall_type?if_exists}" />  
	       <@s.reset value="重置"/>
