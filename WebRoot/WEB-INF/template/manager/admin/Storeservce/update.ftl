...
<body >
<@s.form action="/admin_Storeservce_update.action"  method="post" validate="true"  id="detailForm">
<div class="postion">
 当前位置：会员管理 > 区域代理 > 修改门店服务
</div>
<div class="rtdcont">
	<div class="rdtable">
		<table  width="100%" cellspacing="0" cellpadding="0">
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<@s.textfield name="storeservce.store_name" cssClass="txtinput" maxLength="50" />
	             	 <input name="storeservce.store_color" id="title_color" type="text" value="${(storeservce.store_color)?if_exists}" size="10"  class="iColorPicker" title="请选择颜色" />
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<@s.radio name="storeservce.state" list=r"#{'0':'启用','1':'禁用'}"  onclick="getMemValue();"/>
   ...
   <div class="bsbut_detail">
           <@s.token/>
           <@s.hidden name="storeservce.store_id"/>
