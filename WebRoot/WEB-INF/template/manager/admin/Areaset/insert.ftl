<html>
  ...
  <body>
  <@s.form action="/admin_Areaset_insert.action" method="post" validate="true" id="modiy_form">
  <@s.hidden name="smode_id" />
<div class="postion">
  <!--当前位置-->
  当前位置:商城管理 > 系统配置 > 配送方式>添加区域设置
</div>
<div class="rtdcont">
	<div class="rdtable">
