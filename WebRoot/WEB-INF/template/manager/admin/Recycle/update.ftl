   ...
   <div class="rdtable">
        <div class="email">
          <table width="100%" cellpadding="0" cellspacing="0" class="inboxDTab">
             ...
             <tr>
               <td colspan="2" class="butTd" aling="center"><input type="button" class="rbut" value="<< 返回" onclick="linkToInfo('/admin_Recycle_list.action','parentMenuId=${parentMenuId?if_exists}&selli=${selli?if_exists}');">&nbsp;&nbsp;
              </td>
             </tr>
          </table>
        </div>
