<html>
  ...
  <body>
<@s.form action="/admin_Roleright_update.action" method="post" validate="true" id="modiy_form">
<div class="postion">
  当前位置:系统管理 > 帐号管理 > 操作权限管理 > 修改操作权限
</div>
<div class="rtdcont">
	<div class="rdtable">
		<table  width="100%" cellspacing="0" cellpadding="0">
		  <tr>
           ...
           <tr id="adminmenu" style="display:<#if roleright.syscode=='sys'><#else>none</#if>">
            ...
            <tr id="membermenu" style="display:<#if roleright.syscode=='b2c'><#else>none</#if>">
             <td class="table_name">所属菜单<font color='red'>*</font></td>
             <td>
             <script type="text/javascript">
        	  d = new dTree('d');
   ...
   <div class="bsbut_detail">
    <@s.token/>
	       <@s.hidden name="roleright.right_id"/>
