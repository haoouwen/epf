<html>
  ...
  <body>
<@s.form action="/admin_Keyword_insert.action" method="post" validate="true" id="modiy_form">
<div class="postion">
  <!--当前位置--> 当前位置:网站管理 > 基本功能 > 关键字管理 > 添加关键字
</div>
<div class="rtdcont">
	<div class="rdtable">
		<table  width="100%" cellspacing="0" cellpadding="0">
		 ...
		 <tr>
            ...
            <tr>
             ...
             <@s.select name="keyword.module_type" list="commparaList" listValue="module_name" listKey="module_type" headerKey="0" headerValue="请选择"/>
            ...
            <tr>
             <td class="table_name">前台显示</td>
             <td>
             	<@s.radio name="keyword.is_show" list=r"#{'0':'显示','1':'不显示'}" value="1"/>
             </td>
           </tr>
