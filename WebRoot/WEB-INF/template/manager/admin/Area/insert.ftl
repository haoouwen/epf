<html>
  ...
  <body>
  <@s.form action="/admin_Area_insert.action" method="post" validate="true" id="modiy_form">
<div class="postion">
  <!--当前位置-->
  当前位置:系统管理 > 系统管理 > 地区管理 > 添加地区
</div>
<div class="rtdcont">
	<div class="rdtable">
		 ...
		 <tr>
           ...
           <tr>
            ...
            <tr>
             ...
             <td>
             	<span><img class='ltip' src="/include/common/images/light.gif" alt="新增保存后,请点击更新缓存" />
