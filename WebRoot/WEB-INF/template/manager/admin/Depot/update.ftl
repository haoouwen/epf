<html>
  ...
  <body>
  <@s.form action="/admin_Depot_update.action" method="post" validate="true" id="modiy_form">
<div class="postion">
  <!--当前位置-->
  当前位置:商品管理 >库存管理 > 修改仓库
   </div>
	           ...
	           <tr>
		           ...
		           <tr>
		            ...
		            <tr>
		               ...
		               <#else>
		                 <@s.radio name="depot.is_sys" list=r"#{'0':'是','1':'否'}"/>
		             	     <font color="red">系统仓库是不可删除！</font>
	               ...
	               <tr>
		             ...
		             <td>
		                ...
		                <img class="ltip" src="/include/common/images/light.gif" alt="手机号码格式:只能以13/15/18开头的11位数字">
