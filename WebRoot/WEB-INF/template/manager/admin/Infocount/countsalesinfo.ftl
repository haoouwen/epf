<html>
  ...
  <body>
<@s.form action="/admin_Infocount_countsalesinfo.action" id="indexForm" method="post" validate="true" >
<!--当前位置-->
	   ...
	   <div class="rseacher">
	     <table cellpadding="0" cellspacing="0">
	      <tr>
	       ...
	       <td><input type="button" class="rbut" value="查询" onclick="submitSearch();showSearchDiv('area_attr','','search_area_attr','','indexForm');"></td>
   ...
   <div class="rtable" ></div>
     ...
     <table cellpadding="0" cellspacing="0" width="100%" >
	   <tr>
	     <td>
	       <ul class="inforstul">
	        <li><a href="javascript:void(0);" onclick="changeChart('sales');">订单成交额</a></li> 
