<html>
  ...
  <@s.form action="/admin_Extendattr_update.action" method="post" validate="true" id="cat_attr_s">
<div class="postion">
  <!--当前位置-->
   	当前位置：商品管理 > 商品属性管理 > 属性列表 > 修改属性
</div>
<div class="rtdcont">
	<div class="rdtable">
		 ...
		 <!--详细页table的数据-->
		       <tr>
		           ...
		           <tr>
		             ...
		             <td>
		                <@s.radio name="extendattr.option_type" list=r"#{'0':'选择项','1':'输入框','2':'下拉框'}" checked="true" />
		           ...
		           <tr>
		             ...
		             <td>
		         		<@s.textfield name="extendattr.default_value" cssClass="txtinput" maxLength="100" cssStyle="width:360px"/>
		           ...
		           <tr>
			         ...
			         <td>
			         	<@s.radio name="extendattr.is_display" list=r"#{'0':'显示','1':'不显示'}"  checked="true" />
   ...
   <div class="bsbut_detail">
    <!--操作按钮-->
    		 <@s.hidden name="extendattr.ex_attr_id" /> 
