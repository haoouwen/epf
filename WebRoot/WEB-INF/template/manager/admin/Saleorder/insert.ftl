<html>
  ...
  <body>  
<@s.form action="/admin_Saleorder_insert.action" method="post" validate="true"  id="detailForm">
<div class="postion">
	当前位置：营销推广 > 促销管理 > 添加订单促销
</div>
<div class="rtdcont">
	<div class="rdtable">
	    <h2>基本信息</h2>
		<table  width="100%" cellspacing="0" cellpadding="0">
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<@s.textfield name="saleorder.sale_name" cssClass="txtinput" maxLength="20" />
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	                <@s.radio name="saleorder.info_state" list=r"#{'1':'启用','0':'禁用'}" value="0"/>
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<@s.textfield name="saleorder.priority" cssClass="txtinput" cssStyle="width:40px;" maxLength="20"  value="50" onkeyup="checkNum(this)"/>
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<input type="checkbox" name="saleorder.platform" value="0"<#if saleorder!=null && saleorder.platform?if_exists?trim?index_of('0') gt -1>checked</#if>/>PC端
	             	<input type="checkbox" name="saleorder.platform" value="1"<#if saleorder!=null && saleorder.platform?if_exists?trim?index_of('1') gt -1>checked</#if>/>触屏端
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	                <@s.radio name="saleorder.is_recome" list=r"#{'1':'是','0':'否'}" value="0"/></br>
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<#list commparaList as commpara>
	             	  <input type="checkbox" name="saleorder.member_level" value="${commpara.level_code}"<#if saleorder!=null && saleorder.member_level?if_exists?index_of('${commpara.level_code?trim}') gt -1>checked</#if>/>${commpara.level_name}
	             	</#list>
		...
		<table  width="100%" cellspacing="0" cellpadding="0">
			 <tr>
	           <td class="table_right">
	             	  <input type="radio" name="saleorder.term_state" value="1" onclick="selectRadio('saleorder.term_state','term');clearCoupon();hideCoupon();" <#if saleorder!=null && saleorder.term_state?if_exists=='1'>checked</#if>>当订单总价满X时,给予优惠</br>
	             	  <div class="coupon" id="term1">订单金额满<input  type="text" style="width:50px;heigth:24px;" id="need_money1" onkeyup="checkNum(this)" <#if saleorder!=null && saleorder.term_state?if_exists=='1'>value="${saleorder.need_money?if_exists}"</#if>/></div>
	             	 <input type="radio" name="saleorder.term_state" value="2" onclick="selectRadio('saleorder.term_state','term');clearCoupon();showCoupon();" <#if saleorder!=null && saleorder.term_state?if_exists=='2'>checked</#if>>对所有订单给予优惠</br>
		...
		<table  width="100%" cellspacing="0" cellpadding="0">
			 <tr>
	           <td class="table_right">
	             	  <input type="radio" name="saleorder.coupon_state" value="1" onclick="selectRadio('saleorder.coupon_state','coupon')" <#if saleorder!=null && saleorder.coupon_state?if_exists=='1'>checked</#if>>订单送优惠券</br>
	             	  ...
	             	  <input type="radio" name="saleorder.coupon_state" value="2" onclick="selectRadio('saleorder.coupon_state','coupon')" <#if saleorder!=null && saleorder.coupon_state?if_exists=='2'>checked</#if>>订单送红包</br>
                      <div class="coupon" id="coupon2">
	             	  ...
	             	  <input type="radio" name="saleorder.coupon_state" value="3" onclick="selectRadio('saleorder.coupon_state','coupon')" <#if saleorder!=null && saleorder.coupon_state?if_exists=='3'>checked</#if>>订单免运费</br>	             	  
	             	  <div id="couponDiv">
