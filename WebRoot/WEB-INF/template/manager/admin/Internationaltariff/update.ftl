<html>
  <head>
    <title>修改国际运费模版</title>
  </head>
<body >
<@s.form action="/admin_Internationaltariff_update.action"  method="post" validate="true"  id="detailForm">
<div class="postion">
 当前位置：商城管理 > 物流管理 > 修改国际运费模版
</div>
<div class="rtdcont">
	<div class="rdtable">
		<table  width="100%" cellspacing="0" cellpadding="0">
			   ...
			   <tr>
	           <td class="table_name" width="20%">国际运费名称<font color='red'>*</font></td>
	           <td>
   ...
   <div class="bsbut_detail">
 		    <@s.token/>
 		   <@s.hidden name="internationaltariff.ief_id"/>
