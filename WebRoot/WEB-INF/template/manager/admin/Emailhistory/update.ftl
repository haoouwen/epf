<html>
  ...
  <body>
  <@s.form action="/admin_Emailhistory_update.action" method="post" validate="true" id="modiy_form">
<div class="postion">
  <!--当前位置-->
  当前位置:会员管理 > 会员相关 > 修改电子邮件
</div>
<div class="rtdcont">
	<div class="rdtable">
		<table  width="100%" cellspacing="0" cellpadding="0">
		 <!--详细页table的数据-->
	            ...
	            <@s.hidden name="emailhistory.temp_code" value="${emailhistory.temp_code?if_exists}"/>
		</table>
	</div>
	<div class="clear"/>
   <div class="bsbut_detail">
    <!--操作按钮-->
	       <@s.hidden name="emailhistory.trade_id"/>
	       	<@s.hidden name="emailhistory.send_name"/>
