...
<body >
<@s.form action="/admin_Taxrate_update.action"  method="post" validate="true"  id="modiy_form">
<div class="postion">
 当前位置：系统管理 > 系统管理 > 修改进出口税率
</div>
<div class="rtdcont">
	<div class="rdtable">
		<table  width="100%" cellspacing="0" cellpadding="0">
	       ...
	       <tr>
	           ...
	           <td>
	             	<@s.textfield  name="taxrate.sort_no"  maxLength="10"  onkeyup="checkNum(this);" cssStyle="width:50px;" />
			 ...
			 <tr>
	           ...
	           <td>
	             	<@s.textfield name="taxrate.tax_price" cssStyle="width:50px;" maxLength="20" />
			 ...
			 <tr>
	           ...
	           <td>
	             	...
	             	<img class='ltip' src="/include/common/images/light.gif" alt="提示:税率符号是百分率的"/>
   ...
   <div class="bsbut_detail">
           <@s.token/>
           <@s.submit value="保存"/>
           <@s.hidden name="taxrate.tax_id"/>
           <@s.hidden name="taxrate.up_tax_id"/>
		   ...
		   <@s.hidden name="oldinfotitle" value="${(taxrate.tax_name)?if_exists}"/>
