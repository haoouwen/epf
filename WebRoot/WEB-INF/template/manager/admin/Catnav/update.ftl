...
<body >
<@s.form action="/admin_Catnav_update.action"  method="post" validate="true" id="modiy_form">
<div class="postion">
 当前位置：网站管理 > 商城导航 > 修改分类导航
</div>
<div class="rtdcont">
	<div class="rdtable">
		<table  width="100%" cellspacing="0" cellpadding="0">
		 <tr>
           ...
           <tr>
	             ...
	             <td class="table_right">
	             	<@s.textfield name="catnav.sort_no"  cssStyle="width:50px;" maxLength="10"/>
