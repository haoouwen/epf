<html>
  ...
  <body>  
<@s.form action="/admin_Redpacket_insert.action" method="post" validate="true"  id="detailForm">
<div class="postion">
	当前位置：营销推广>红包管理 > 添加红包
</div>
<div class="rtdcont">
...
<h2>基本信息</h2>
		<table  width="100%" cellspacing="0" cellpadding="0">
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<@s.radio name="redpacket.info_state" list=r"#{'1':'启用','0':'禁用'}" value="1"/>
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<@s.radio name="redpacket.is_show" list=r"#{'1':'是','0':'否'}" value="1"/>
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	             	<@s.textfield name="redpacket.red_num" cssClass="txtinput" maxLength="20" value="不限制"/>
