<html>
  <head>
	...
	<link rel="stylesheet" href="/include/admin/css/goods.css" type="text/css" />
...
<body>
<@s.form action="/admin_Goodsbrand_insert.action" method="post"   id="gpform" >
<div class="postion">
  <!--当前位置-->
  当前位置:商品管理 > 品牌管理 > 添加品牌
</div>
		...
		<table  width="100%" cellspacing="0" cellpadding="0">
		 <!--详细页table的数据-->
		  <tr>
		             ...
		             <td>
		             	<@s.textfield id="brand_name" name="goodsbrand.brand_name" cssClass="txtinput" maxLength="30" cssStyle="width:300px;" onblur="checkBrandName();"   />
	            ...
	            <tr>
		           ...
		           <tr  style="display:none;">
		             ...
		             <td>
			            <@s.textarea name="goodsbrand.content" id="content" cssClass="txtinput" cssStyle="width:300px;height:200px;" onkeyup="checkLength(this,800);"/>
		         ...
		         <tr  style="display:none;">
                    <td class="table_name">SEO标题:</td>
		             <td>
		             		<@s.textarea name="goodsbrand.seo_title" cssClass="mailCss"  onkeyup="checkLength(this,100);" />
