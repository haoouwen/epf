<html>
  ...
  <body>
<@s.form action="/admin_Rate_insert.action" method="post" validate="true" id="modiy_form">
<!--当前位置开始-->
<div class="postion">
当前位置:系统管理 > 系统管理 > 添加汇率
</div>
		 ...
		 <!--详细页table的数据开始-->
          ...
          <tr>
           ...
           <tr>
             ...
             <td>
	             <@s.radio name="rate.enables" list=r"#{'0':'是','1':'否'}" value="0"/>
	 	         <@s.fielderror><@s.param>rate.enables</@s.param></@s.fielderror>
    		 </td>
           </tr>
       
           <tr>
             <td class="table_name" id="input1">汇率<font color='red'>*</font></td>
             <td>
           ...
           <tr>
             ...
             <td>
	             <@s.radio name="rate.endefault" list=r"#{'0':'是','1':'否'}" value="1"/>
