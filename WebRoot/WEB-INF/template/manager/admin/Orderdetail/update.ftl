<html>
  ...
  <body>
<@s.form action="/admin_Orderdetail_update.action" method="post" validate="true" id="modiy_form">
<!--当前位置开始-->
<div class="postion">
当前位置:商城管理 > 商品相关 > 详细订单 >修改详细订单
</div>
<!--当前位置结束-->
<div class="rtdcont">
	<div class="rdtable">
		<table  width="100%" cellspacing="0" cellpadding="0">
		 <!--详细页table的数据开始-->
           ...
           <tr>
             <td class="table_name">商品标识<font color='red'>*</font></td>
             <td>
           ...
           <tr>
             <td class="table_name">商品价格<font color='red'>*</font></td>
             <td>
           ...
           <tr>
             <td class="table_name">商品数量<font color='red'>*</font></td>
             <td>
           ...
           <tr>
             <td class="table_name">商品属性<font color='red'>*</font></td>
             <td>
             <@s.textarea name="goodseval.explan_content" cssStyle="width:500px;height:100px" cssClass="txtinput" onkeyup="checkLength(this,600)"/>
             	<@s.textfield name="orderdetail.goods_attr" cssClass="txtinput" maxLength="20"/>
   ...
   <div class="bsbut_detail">
   	   <@s.hidden name="orderdetail.trade_id"/>
