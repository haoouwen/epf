<html>
  <head>
    <title>添加门店服务介绍</title>
     <#include "/include/uploadInc.html">
  </head>
  <body>  
<@s.form action="/admin_Storeintro_insert.action" method="post" validate="true"  id="detailForm">
<div class="postion">
	当前位置：会员管理 > 区域代理 > 添加门店服务介绍
</div>
<div class="rtdcont">
	<div class="rdtable">
		<table  width="100%" cellspacing="0" cellpadding="0">
			 <tr>
			  ...
			  <tr>
	           ...
	           <td class="table_right">
	               <@s.textfield name="storeintro.sort_no" cssClass="txtinput" maxLength="5" value="0" cssStyle="width:50px;" onkeyup="checkNum(this);"/>
			 ...
			 <tr>
	           ...
	           <td class="table_right">
	            <@s.radio name="storeintro.is_show" list=r"#{'0':'显示','1':'不显示'}" value="0" onclick="getMemValue();"/>
