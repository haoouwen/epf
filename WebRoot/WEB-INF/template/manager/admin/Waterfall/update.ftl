<html>
  ...
  <body>
   	<@s.form  id="water" action="/admin_Waterfall_update.action" method="post" validate="true" >
   <div class="postion">当前位置:网站管理 > 网站页面 > 瀑布流管理 > 修改瀑布流</div>
<div class="rtdcont">
   ...
   <div class="rdtable">
        <table class="wwtable" cellspacing="1" cellpadding="8">
		       ...
		       <tr>
	             ...
	             <td>
	             	<@s.textfield name="waterfall.wf_code" cssClass="input" onkeyup="checkLength(this,20);" maxlength="20" cssStyle="width:220px;" readonly="true"/>
	           ...
	           <tr>
	             ...
	             <td>
	             	<@s.select name="waterfall.temp_type" cssClass="input" list="templateList" listKey="template_id" listValue="template_name"  onchange="selected()" id="wf_code"/>
