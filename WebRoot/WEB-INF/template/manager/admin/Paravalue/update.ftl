<html>
  ...
  <body>
<@s.form action="/admin_Paravalue_update.action" method="post" validate="true" id="modiy_form">
<!--当前位置开始-->
<div class="postion">
当前位置：商城管理 > 商品参数管理 > 修改参数值
</div>
<!--当前位置结束-->
<div class="rtdcont">
	<div class="rdtable">
		<table  width="100%" cellspacing="0" cellpadding="0">
		 <!--详细页table的数据开始-->
           ...
           <tr>
             ...
             <td>
             	<@s.textfield name="paravalue.sort_no" cssClass="txtinput" maxLength="11" onkeyup="checkNum(this)"/>
   ...
   <div class="bsbut_detail">
       ...
       <@s.hidden name="paravalue.para_id"  />  
       <@s.hidden name="pgi_s"/>  
       <@s.hidden name="paravalue.in_date"/>   
       <@s.hidden name="oldinfotitle" value="${(paravalue.para_name)?if_exists}"/> 
