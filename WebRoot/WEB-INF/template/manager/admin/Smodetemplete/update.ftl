<html>
  ...
  <@s.form action="/admin_Smodetemplete_update.action" method="post" validate="true" id="modiy_form">
<div class="postion">
  当前位置:商城管理 > 配送管理 > 修改配送摸版
</div>
<div class="rtdcont">
	<div class="rdtable">
   ...
   <div class="bsbut_detail">
	     <@s.hidden name="smodetemplete.trade_id" /> 
     <@s.hidden name="smodetemplete.smode_id" /> 
