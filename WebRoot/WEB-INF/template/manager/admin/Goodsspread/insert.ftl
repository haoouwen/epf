<html>
  ...
  <body>
  <@s.form action="/admin_Goodsspread_insert.action" method="post" validate="true" id="modiy_form">
<div class="postion">
  <!--当前位置-->
  当前位置:营销推广 > 推广管理 > 商品推广 > 添加商品推广
</div>
<div class="rtdcont">
	<div class="rdtable">
		 ...
		 <!--详细页table的数据-->
		    <tr>
	            ...
	            <tr>
		           ...
		           <tr>
			             <td class="table_name">推广图片<font color='red'>*</font></td>
			             <td>
			    ...
			    <tr>
		             ...
		             <td>
		             	<@s.textarea name="goodsspread.slogan" cssClass="txtinput" cssStyle="width:300px;" maxLength="100"/>
		       ...
		       <tr>
                ...
                <tr>
	             ...
	             <td>
		             <input type="text"  name="goodsspread.spread_starttime"   value="<#if goodsspread!=null>${goodsspread.spread_starttime?if_exists}</#if>" class="Wdate upWdate" style="width:162px;" id="updown1" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'updown2\',{M:0,d:0})||$dp.$DV(\'2020-4-3\',{M:0,d:0})}'})"/>
	           ...
	           <tr>
	             ...
	             <td>
	              <input type="text"  name="goodsspread.spread_endtime" value="<#if goodsspread!=null>${goodsspread.spread_endtime?if_exists}</#if>" class="Wdate downWdate" style="width:162px;" id="updown2" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'updown1\',{M:0,d:0});}',maxDate:'2020-4-3'})"/>
