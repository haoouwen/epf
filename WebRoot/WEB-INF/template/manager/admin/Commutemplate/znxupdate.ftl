<html>
  ...
  <body>
  <@s.form action="/admin_Commutemplate_znxupdate.action" method="post" validate="true" id="modiy_form">
<div class="postion">
  <!--当前位置-->
  会员管理 > 通讯模拟管理 > 站内信模板 > 修改站内信模板
</div>
<div class="rtdcont">
	<div class="rdtable">
		<table  width="100%" cellspacing="0" cellpadding="0">
		 <!--详细页table的数据-->
		           ...
		           <tr>
		             ...
		             <td>
		                <@s.textarea name="commutemplate.tag_desc" cssClass="txtinput" maxLength="300" cssStyle="width:500px;height:150px;"onkeyup="checkLength(this,300)" readonly="true"/>
		      ...
		      <!--是否为系统模板默认否-->
		       ...
		       <!--模板类型默认站内信（该模板为站内信模板）-->
			           <@s.hidden name="commutemplate.temp_type" cssClass="txtinput" maxLength="20" value="2"/> 
   ...
   <div class="bsbut_detail">
    <!--操作按钮-->
	      ...
	      <@s.hidden name="oldtempcode" value="${commutemplate.temp_code?if_exists}"/>
           ...
           <@s.submit value="保存" />
	       <@s.reset value="重置"/>
	       <input type="button" name="returnList" value="返回列表" onclick="linkToInfo('/admin_Commutemplate_znxlist.action','');"/>    
   </div>
</div>
<div class="clear"></div>
</@s.form>
