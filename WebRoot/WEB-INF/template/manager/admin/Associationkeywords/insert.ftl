<html>
  ...
  <body>  
<@s.form action="/admin_Associationkeywords_insert.action" method="post" validate="true"  id="modiy_form">
<div class="postion">
	当前位置：网站管理 > 联想关键字 >添加联想关键字
</div>
<div class="rtdcont">
	<div class="rdtable">
		<table  width="100%" cellspacing="0" cellpadding="0">
           ...
           <tr>
			 ...
			 <tr>
	           ...
	           <td>
	               <@s.radio name="associationkeywords.ass_key_words_show" list=r"#{'0':'是','1':'否'}"value="0"/>
             ...
             <td>
             	<@s.textfield name="associationkeywords.sort_no" value="50" cssClass="txtinput" style="width:80px;" maxLength="4"/>
   ...
   <div class="bsbut_detail">
    <@s.token/>    
           <@s.hidden name="token_value" value="${get_token_value?if_exists}"/>
            <@s.hidden name="associationkeywords.ass_key_words_number" value="0"/>
