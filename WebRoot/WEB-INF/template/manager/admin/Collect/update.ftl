<html>
  ...
  <body>
  <@s.form action="/admin_Collect_update.action" method="post" validate="true" id="modiy_form">
<div class="postion">
  <!--当前位置-->
  当前位置:商城管理 > 商品相关 > 商品收藏 > 修改商品收藏
</div>
<div class="rtdcont">
	<div class="rdtable">
		 ...
		 <!--详细页table的数据-->
		 		 <#if goods!=null>
		           <tr>
		             ...
		             <td>
		             	<@s.textfield name="goods.goods_name" cssClass="txtinput" maxLength="20"/>
