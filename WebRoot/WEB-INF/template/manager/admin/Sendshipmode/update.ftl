<html>
  ...
  <@s.form action="/admin_Sendshipmode_update.action" method="post" validate="true" id="modiy_form">
<div class="postion">
  当前位置:商城管理 > 物流管理 > 修改配送方式
</div>
<div class="rtdcont">
	<div class="rdtable">
		 ...
		 <tr>
	            ...
	            <tr>
	              ...
	              <tr>
		             ...
		             <td>
		                 <@s.radio name="sendshipmode.reach_pay" list=r"#{'1':'否','0':'是'}" />
		           ...
		           <tr>
		             ...
		             <td>
		                <@s.radio name="sendshipmode.is_insured" list=r"#{'1':'否','0':'是'}" />
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield name="sendshipmode.rate" cssClass="txtinput" cssStyle="width:80px;" maxLength="11"/>
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield name="sendshipmode.mix_insured" cssClass="txtinput" cssStyle="width:100px;" maxLength="11"/>
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield name="sendshipmode.max_insured" cssClass="txtinput" cssStyle="width:100px;" maxLength="11"/>
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield name="sendshipmode.sort_no" cssStyle="width:80px;" size="12" onkeyup="checkNum(this);"   maxLength="11"/>
   ...
   <div class="bsbut_detail">
    <@s.token/>    
	       <@s.hidden name="oldinfotitle" value="${sendshipmode.smode_name?if_exists}"/>
	       ${listSearchHiddenField?if_exists}
	        <@s.hidden name="sendshipmode.smode_id"/>
           <@s.submit value="保存" />
	       <@s.reset value="重置"/>
