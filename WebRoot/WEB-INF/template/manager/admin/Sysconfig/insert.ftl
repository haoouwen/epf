...
<body>
<@s.form action="/admin_Sysconfig_insert.action" method="post" validate="true" id="modiy_form">
<div class="postion">
		 ...
		 <td class="table_name">排序:</td>
           ...
           <tr>
             ...
             <td>
             	...
             	<img class='ltip' src="/include/common/images/light.gif" alt='<@s.property value="%{getText('manager.admin.Sysconfig.var_name')}"/>'>
