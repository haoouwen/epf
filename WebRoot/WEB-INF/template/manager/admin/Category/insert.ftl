<html>
  ...
  <body>
  <@s.form action="/admin_Category_insert.action" method="post" validate="true" id="gpform">
<div class="postion">
  <!--当前位置-->
  当前位置:商城管理 > 分类管理 > 添加分类
</div>
<div class="rtdcont">
	<div class="rdtable">
		<table  width="100%" cellspacing="0" cellpadding="0">
		 <!--详细页table的数据-->
          ...
          <tr>
             <td class="table_name" style="width:220px;" height="60px;">分类名称<font color='red'>*</font></td>
             <td>
          ...
          <td class="table_name">分类图片:</td>
           ...
           <tr>
             ...
             <td>
             	<@s.radio name="category.is_display" list=r"#{'1':'全部显示','2':'分类导航不显示','0':'全部不显示'}" value="1" checked="true"/>
           ...
           <tr>
             ...
             <td>
             	<@s.radio name="category.cat_attribute" list=r"#{'0':'不选','1':'热门分类'}" value="0"  checked="true" />
           ...
           <tr>
             ...
             <td>
             <@s.textfield  id="sort_no"  name="category.sort_no" cssStyle="width:50px;" maxLength="6" onkeyup="checkNum(this);" value="1"/>
           ...
           <tr  style="display:none;">
            ...
            <tr>
             ...
             <td>
             	...
             	[新增保存后,请点击<a href="###" onclick="renewload();"><font color="red">更新缓存</font></a>]</span>
             </td>
           </tr>
   ...
   <div class="bsbut_detail">
    <!--操作按钮-->
	       ...
	       <@s.submit value="保存"/>
	       <@s.reset value="重置"/>
	       <@s.hidden  id="mod_type"  name="module_type" />
