...
<title>${cfg_webname?if_exists}领取优惠券</title>
...
<body>
<div class="top">
   <a href="javascript:gbackhistory();" class="topReturn"><img src="/malltemplate/jiutong/images/topReturn.png"></a>领取优惠券<span class="topCls"></span>
</div>
 ...
 <div class="lqyhj">
    ...
    <ul>
     ...
     <#list couponList as coupon>
        ...
        <li><div><p class="size22">￥<b>${coupon.coupon_money?if_exists}</b>优惠券</p><p>(${coupon.coupon_name?if_exists})</p></div>
        <p class="padp"><a href="javascript:void(0);" onclick="gotoCou_Red('/webapp/coupon_${coupon.coupon_id?if_exists}.html?platformType=0');">
