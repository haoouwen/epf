...
<title>${cfg_webname?if_exists}-在线客服</title>
...
<body>
<div class="top">
   <a href="javascript:gbackhistory();" class="topReturn"><img src="/malltemplate/jiutong/images/topReturn.png"></a>在线客服<span class="topCls"></span>
</div>
<#include "/WEB-INF/template/webapp/jiutong/mbCommonTop.html">
<!--门店详细页-->
<div >
     
     <iframe style="margin-top:-35px;display:block;" frameborder="0" marginheight="0" marginwidth="0" 
     border="0" id="alimamaifrm" name="alimamaifrm" scrolling="no" height="500px" width="100%" 
     src="http://chat.looyuoms.com/chat/chat/p.do?c=20001014&f=10054779&g=10058243"></iframe>
