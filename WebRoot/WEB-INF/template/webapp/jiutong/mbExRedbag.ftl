...
<title>${cfg_webname?if_exists}—兑换红包</title>
...
<body>
<@s.form action="/webapp/redsumer!exRedbag.action"  method="post" name="formshopcongif" validate="true" id="formshopcongif">
<div class="top">
   <a href="javascript:gbackhistory();" class="topReturn"><img src="/malltemplate/jiutong/images/topReturn.png"></a>兑换红包<span class="topCls"></span>
</div>
...
<div class="forgetPswDiv">
   <p><b>输入红包号码</b></p>
   <p class="forgetP">
   <input type="text" class="forgetText"  name="red_no">
   </p>
   <p>
     <@s.fielderror><@s.param>red_no</@s.param></@s.fielderror>
   </p>
