...
<div class="forgetPswDiv">
   <p><b>请输入已验证手机：</b></p>
   <p class="forgetP"><input type="text" class="forgetText" placeholder="请输入已验证手机" id="username" name="username" ></p>
...
<div class="forgetPswDiv">
    ...
    <p class="forgetP"><input type="text" name="commentrand" maxLength="4" class="forgetText" id="commentrand" onfocus="RandsForm();" onblur="RandsIsNull();" placeholder="请输入图形验证码"/><span class="spanValidationR"><img src="/imgrand.action"  onclick="changeValidateCode(this)" id="validateCode"/></span></p>
   <p><input type="button" id="cpc" class="getYzm" onclick="send();" value="获取短验证码"></p>
   <p class="gray">如在<span id="haiyou">60</span>秒内还没有收到短信验证码，请重新获取验证码</p>
   <p><b>请填写短信验证码</b></p>
   <p class="forgetP"><input type="text" class="forgetText" placeholder="请输入验证码" id="checkcode" name="checkcode"></p>
...
<div class="forgetPswDiv">
   <p><b>输入新密码</b></p>
   <p class="forgetP"><input id="password" name="password" type="password" class="forgetText" onfocus="PasswordForm()" onblur="PasswdIsNull()"  placeholder="请输入新密码"></p>
   <p><b>重新输入密码</b></p>
   <p class="forgetP"><input id="rep_pass" name="rep_pass" type="password" class="forgetText" onblur="Confirm_pwdIsNull();" onfocus="Confirm_pwdForm()" placeholder="请再次输入密码"></p>
