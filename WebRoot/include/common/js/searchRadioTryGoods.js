...
function saveGoods(){
	...
	$("#searchgoods").jqmHide();
	 //清除提示的
	 var hidden_goodsname=$("#hidden_goodsname").val();
	 if(hidden_goodsname!=null&&hidden_goodsname!=""){
     	$("#goods_tip_id").hide();
	 }else{
	     $("#goods_tip_id").show();
	 }
...
function search(){
	...
	$('#searchgoodslist').mall({
		    actionName:'/goods!searchTryGoods.action?s_goods_name='+s_goods_name+"&flag="+fla+"&is_up=1",
