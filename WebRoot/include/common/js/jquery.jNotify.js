...
(function($){
	...
	$.jNotify = {
		defaults: {
			...
			clickOverlay : false,	        // close the notice box on the overlay click ?
			...
			LongTrip : 150,					// in pixel, length of the move effect when show and hide
			...
			ColorOverlay : '#F8F8F8',		// color of the overlay
