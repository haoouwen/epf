...
document.write ('    <DIV align=center class=\"keyboard\" id=\"softkeyboard\" name=\"softkeyboard\" style=\"position:absolute; left:680px; top:490px; width:517px; z-index:180;display:none\">');
document.write ('  <table width=\"348\" border=\"0\" align=\"center\" cellpadding=\"3\" cellspacing=\"3\" bgcolor=\"#EBEBEB\">');
...
document.write ('          <INPUT class=button type=button value=输入完毕 name=\"Submit3\" onclick=\"OverInput();\"> <INPUT class=button type=reset value=输错重来 name=\"Submit23\"> ');
...
//输入完毕
 ...
 {
  document.forms["form"].passwd.value=document.forms["Calc"].password.value;
...
//显示软键盘
 function showkeyboard()
 {
  ...
  document.forms["form"].passwd.value="";
 }
//设置是否大写的值
