...
<% 
	String user_name = "",cust_type="",cust_id="",menu_right="",registertype="",custnum="";
...
<%	
	    ...
	    %>
			document.write('<a href="/webappregister.html?custnum=<%=custnum %>&registertype=<%=registertype %>">注册</a>&nbsp;|&nbsp;<a href="/webapplogin.html?loc=<%=reqUrl %>">登录</a>');
		<%
	}
%>