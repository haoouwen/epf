	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: '/include/components/progressbar/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'/include/components/progressbar/images/progressbg_red.gif',
									30: '/include/components/progressbar/images/progressbg_orange.gif',
									70: '/include/components/progressbar/images/progressbg_green.gif'
								},
				// Internal use
				running_value	: 0,
				value			: 0,
