...
<%
	...
	if(verify_result){//验证成功
		...
		if(trade_status.equals("TRADE_FINISHED") || trade_status.equals("TRADE_SUCCESS")){
            ...
            message.append("订单号为：" + out_trade_no + " 的订单支付成功，"); 
            message.append("付款金额为" + total_fee + "元。<br/>");
...
<html>
  <head>
		<title><%=cfg_webname %>-订单支付状态</title>
      ...
      <div class="regMain">
         <div class="regSuMian">
           ...
           <div class="returnhome">
              <p><a href="/">返回首页</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<%=cfg_basehost %>/bmall_Goodsorder_buyOrderView.action?goodsorder.order_id=<%=out_trade_no %>&order_state=2">查看订单</a></p>
           </div>
