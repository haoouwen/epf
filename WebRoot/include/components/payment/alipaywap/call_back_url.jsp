...
<%
    ...
    String total_fee = GoodsOrderFuc.getGoodsOrder(out_trade_no).getTatal_amount().toString();
		...
		//——请根据您的业务逻辑来编写程序（以下代码仅作参考）——
			...
			//判断该笔订单是否在商户网站中已经做过处理
		      ...
		      if(GoodsOrderFuc.verifyOrderState(out_trade_no)){
			      GoodsOrderFuc.alipaywap(out_trade_no,trade_no,pay_id);
			  }
		//该页面可做页面美工编辑
		//out.println("支付成功<br />");
...
<div class="registerDiv">
    <div class="sucRegister">
       ...
       <p>金额：<b><%=total_fee %></b></p>
      <p><a href="/mindex.html">返回首页</a>&nbsp;&nbsp;<a href="<%=cfg_mobiledomain %>/webapp/goodsorder!webappOrderDetail.action?goodsorder.order_id=<%=out_trade_no %>&order_state=2">查看订单</a></p>
    </div>
</div>
