...
/* *
 ...
 该页面调试工具请使用写文本函数logResult，该函数在com.rbt.pay.alipay.util文件夹的AlipayNotify.java类文件中
...
<%
	...
	if(AlipayNotify.verify(params)){//验证成功
		...
		if(Integer.valueOf(success_num)>0){
		   
		   GoodsOrderFuc.dealRefund_notify(batch_no,result_details,"0");   
