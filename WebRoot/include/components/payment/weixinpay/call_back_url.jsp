              ...
              if(return_code.equals("SUCCESS")&&result_code.equals("SUCCESS")){
                  ...
                  if(attach_str.equals("1")){
                     if(GoodsOrderFuc.verifyOrderState(out_trade_no)){
			            GoodsOrderFuc.useWXOnlinePay(out_trade_no,recharge_amount+"",transaction_id,pay_id,"1");
			         }
                   ...
                   String getXmlString=WXPay.responeAppScanPayService(wxScanPayResData);
			  }
            }
        }
%>
