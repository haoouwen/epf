...
<%
    String cfg_mobiledomain = "",custnum="",registertype="",goods_no="",goods_id="";
	...
	if (null != request.getParameter("goods_no")&& !"".equals(request.getParameter("goods_no"))) {
		goods_no = request.getParameter("goods_no");
	}
	if (null != request.getParameter("goods_id")&& !"".equals(request.getParameter("goods_id"))) {
...
<body>
  <table align="center">
	...
	<tr>
		<td>
		<input type="hidden" value="<%=cfg_mobiledomain %>/webapp/goods!detail.action?gid=<%=goods_id %>&custnum=<%=custnum %>&registertype=<%=registertype %>" id="code_url"/> 
		<div id="qrcode"></div>
		</td>
	</tr>
  </table>
