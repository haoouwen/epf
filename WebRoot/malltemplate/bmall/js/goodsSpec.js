...
$(document).ready(function() {
    ...
    $(".specstr >td > div >ul >li>div").hover(function() {
    ...
    //选择商品规格(标签)
    $(".specstr >td > div > .selsize >li>div").click(function() {
        var css = $(this).attr("class");
        var id = $(this).children("a").attr("id");
        //禁止点击
        if (css.indexOf("disable")>-1) {
        ...
        if (css == "seldiv") {
            ...
            if (specstr_str_all.indexOf(id) > -1) {
                $(this).parent("li").siblings().children("div").removeClass("seldiv");
                $(this).addClass("seldiv");
                $(this).append("<b> </b>");
                $(this).parent("li").siblings().children("div").removeClass("seldiv").find("b").remove();
            } else {
               $(this).removeClass();
            }
        }
    ...
    //选择商品规格(图片)
    $(".specstr >td > div > .selcolor > li>div").click(function() {
        var css = $(this).attr("class");
        var id = $(this).children("a").attr("id");
        //禁止点击
        if (css == "disable") {
