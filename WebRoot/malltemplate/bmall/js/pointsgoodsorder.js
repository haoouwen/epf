...
function submitOrder(){
	  ...
	  //判断库存是否为0
	   var pointsgoods_id = $("#pointsgoods_id").val();
	   var goodsnum = $("#goodsnum").val();
	   var amount = $("#amount").val();
	   $("#addr_id").val(addr_id);
	   var dataUrl = "/mall/pointsgoodsOrder!stockstatus.action?pointsgoods_id=" + pointsgoods_id + "&goodsnum=" + goodsnum +"&amount=" + amount;
	   $.ajax({  	 
        type: "post",    	     
        url: dataUrl,       
        datatype:"json",
