...
document.write ('    <DIV align=center id=\"softkeyboard\" name=\"softkeyboard\" style=\"position:absolute; left:450px; top: 370px; width:517px; z-index:180;display:none\">');
...
//输入完毕
 ...
 {
  document.forms["pay"].pay_password.value=document.forms["Calc"].password.value;
...
//显示软键盘this.ID.style.cssText="position:absolute;marginleft:auto; "; 
 function showkeyboard()
 {
  ...
  document.forms["pay"].pay_password.value="";
 }
//设置是否大写的值
