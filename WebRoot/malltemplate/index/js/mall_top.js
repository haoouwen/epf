	  ...
	  if(cart_num!=0){
	   ...
	   if($.cookie("twgl")!=null&&$.cookie("twgl")!=""){
        ...
        "</div>";     	   
	      ...
	      //html对象赋值
	      cartHtml+=" <p><img src='/malltemplate/index/images/ieCart.gif'  /></p>"
	      //编辑右侧购物车
	      indexHtml+="<p><img src='/malltemplate/index/images/ieCart2.gif' width='240'/></p>"
	 }
	 //给样式为cartcDiv对象赋值  
