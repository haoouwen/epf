...
public class WebAppgoodsModelAction extends WebAppbaseAction  {
	...
	public void getParagroup(String goods_id,String goods_cat) {
		...
		//获取全部自定义参数值
		Map spvMap = new HashMap();
		selfparavalueList = this.selfparavalueService.getList(spvMap);
	}
