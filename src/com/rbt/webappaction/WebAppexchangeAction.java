...
/**
 * @function 功能 app换货action类
 * @author 创建人 HXK
 * @date 创建日期  2015
 */
@Controller
public class WebAppexchangeAction extends WebAppbaseAction implements Preparable{
	...
	public void getLogistics(String smode_id, String number) {
		...
		public String buygoodsview() throws Exception {
			commonView();
			return goUrl("mbbuygoodsreturnview");
		}
		...
		public String agreeRefundGoods() throws Exception{
					...
					ordertransService.inserOrderTran(order_id, session_cust_id, session_user_id,
							CommparaFuc.getReason("1", "同意换货!"), "5", session_user_name);
	                String message = "";
