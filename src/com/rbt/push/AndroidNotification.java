...
public abstract class AndroidNotification extends UmengNotification {
	...
	public void setDisplayType(String dispaytype) throws Exception {
		setPredefinedKeyValue("display_type", dispaytype);
	}
	///通知栏提示文字
	...
	public void goAppAfterOpen() throws Exception {
		System.out.println("==========goAppAfterOpen=====sss=========");
		//setAfterOpenAction(AfterOpenAction.go_app);
		setAfterOpenAction("go_app");
	}
	...
	public void setAfterOpenAction(AfterOpenAction action) throws Exception {
		System.out.println("==========setAfterOpenAction========"+action+"======");
		System.out.println("==========goAppAfterOpen========action.toString()"+action.toString()+"======");
		setPredefinedKeyValue("after_open", action.toString());
	}
	public void setAfterOpenAction(String action) throws Exception {
