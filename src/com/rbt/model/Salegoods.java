...
public class Salegoods implements Serializable {
	...
	private String sale_name_list;
	
	public String getSale_name_list() {
		return sale_name_list;
	}
	public void setSale_name_list(String sale_name_list) {
		this.sale_name_list = sale_name_list;
	}
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("Salegoods[");
		...
		builder.append(", sale_name_list=");
		builder.append(this.sale_name_list);
		builder.append("]");
