...
public class Signature {
    ...
    public static String getSignapp(Map<String,Object> map){
        ...
        String result = sb.toString();
        result += "key=" + ConfigureApp.getKey();
        Util.log("Sign Before MD5:" + result);
        result = MD5.MD5Encode(result,"UTF-8").toUpperCase();
        Util.log("Sign Result:" + result);
        return result;
     ...
     * @throws SAXException
     */
    public static boolean checkIsSignValidFromResponseStringAPP(String responseString) throws ParserConfigurationException, IOException, SAXException {
        ...
        map.put("sign","");
        //将API返回的数据根据用签名算法进行计算新的签名，用来跟API返回的签名进行比较
        String signForAPIResponse = Signature.getSignapp(map);
