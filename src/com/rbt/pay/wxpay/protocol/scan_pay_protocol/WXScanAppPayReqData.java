 ...
 * Time: 16:42
 */
public class WXScanAppPayReqData {
	 //每个字段具体的意思请查看API文档
     ...
     */
    public WXScanAppPayReqData(String body,String attach,String outTradeNo,
        ...
        setAppid(ConfigureApp.getAppid());

        //微信支付分配的商户号ID（开通公众号的微信支付功能之后可以获取到）
        setMch_id(ConfigureApp.getMchid());
