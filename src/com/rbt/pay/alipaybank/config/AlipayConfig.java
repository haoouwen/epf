package com.rbt.pay.alipaybank.config;
...
//↓↓↓↓↓↓↓↓↓↓配置基本参数↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
	...
	public static String return_url=SysconfigFuc.getSysValue("cfg_basehost")+"/mall-bank-return_url.html";
	
	//服务器异步通知页面路径:支付宝服务器主动通知商户网站里指定的页面 http 路径。可空
	public static String notify_url=SysconfigFuc.getSysValue("cfg_basehost")+"/include/components/payment/alipaybank/notify_url.jsp";
	...
	public static String refund_notify_url=SysconfigFuc.getSysValue("cfg_basehost")+"/include/components/payment/alipaybank/refund_notify_url.jsp";
